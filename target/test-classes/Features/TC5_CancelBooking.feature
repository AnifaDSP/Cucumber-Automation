@CancelBooking
Feature: Verifying Adactin Cancel Booking Hotel Details

  Scenario Outline: Verifying Adactin Cancel Booking Using Generated Order id
    ...
    Then User should verify the after Cancel Order Id success message "The booking has been cancelled."
  ...
  Scenario Outline: Verifying Adactin Cancel Booking Using Existing Order id
    Given User is an Adactin Page
    When User should Perform Login "<userName>" and "<password>"
    Then User should verify after Login success message "Hello Anifadsp!"
